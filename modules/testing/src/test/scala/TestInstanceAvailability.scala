...
class TestInstanceAvailability extends AnyFunSuite:
  test("Arbitrary[FieldOfViewLike] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[FieldOfViewLike]]" }
    assertTypeError {
  ...
  test("Arbitrary[ImagingTimepoint] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[ImagingTimepoint]]" }
    assertTypeError {
  ...
  test("Arbitrary[ImagingChannel] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[ImagingChannel]]" }
    assertTypeError {
  ...
  test("Arbitrary[ImagingContext] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[ImagingContext]]" }
    assertTypeError {
  ...
  test("Arbitrary[Area] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[Area]]" }
    assertTypeError {
  ...
  test("Arbitrary[MeanIntensity] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[MeanIntensity]]" }
    assertTypeError {
  ...
  test("Arbitrary[DetectedSpot[Double]] is correctly available.") {
    ...
    assertTypeError { "summon[Arbitrary[DetectedSpot[Double]]]" }
    assertTypeError {
